...
Future UML Diagrams modelling the application [Mermaid](https://mermaidjs.github.io/). For example, this will produce a sequence diagram:
...
Future mathematical expressions for elusive machine learning concepts on inner readmes
